        ...
        <table class="table table-sm table-striped m-b-0">
            ...
            <thead>
                <tr>
                    ...
                    <th style="width: 10%; font-weight: 600!important;" class="text-center">
                        Is visible
                    </th>
            ...
            <tbody class="table-striped items sortableOptions">
                <tr class="array-row clonable" style="display: none;">
                    ...
                    <td>
                        <input class="form-control form-control-sm" type="hidden" data-cell-name="item.id">
                        <input class="form-control form-control-sm" type="text" data-cell-name="item.description">
                    </td>

                    <td class="text-center">
                        <input class="align-middle" type="checkbox" data-cell-name="item.is_visible">
                    </td>
                ...
                if($rows != '[]') {
                    $.each($rows, function(key) {
                        ...
                        $.each(this, function(column, value) {
                            ...
                            $tableWrapper.find('tbody tr:last').find('input[type="checkbox"][data-cell-name="item.' + column + '"]').prop("checked", value);
                        });
